...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6 lg:p-10">
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        <h1 class="text-2xl font-bold text-green-800 mb-6">Tambah Data RW</h1>
        
        <form method="POST" action="{{ route('rws.store') }}" class="space-y-6" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="nomor_rw" id="nomor_rw" value="{{ old('nomor_rw') }}" class="input-style" placeholder="Masukkan nomor RW" required>
