        ...
        <aside class="w-64 flex-shrink-0 bg-green-700 text-white flex flex-col">
            ...
            <nav class="flex-grow px-4 py-6">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard.manajemen-konten') }}" class="flex items-center gap-3 px-4 py-3{{ request()->routeIs('dashboard.manajemen-konten') ? 'bg-green-800' : 'text-gray-200 hover:bg-green-800 hover:text-white' }} rounded-lg transition-colors duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
