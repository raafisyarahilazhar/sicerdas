...
<main class="container mx-auto px-4 sm:px-6 py-12">
    <div class="text-sm text-gray-500 mb-6">
        ...
        <span class="font-semibold text-green-700">Pengumuman</span>
    </div>
    {{-- Judul Halaman --}}
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-green-800">Pengumuman Resmi Desa</h1>
        <p class="mt-2 text-lg text-gray-600">Ikuti pengumuman terbaru dari desa kita.</p>
    </div>
