...
<main class="container mx-auto px-4 sm:px-6 py-12">
    <div class="text-sm text-gray-500 mb-6">
        ...
        <span class="mx-2">></span>
        <span class="font-semibold text-green-700">{{ $pengumuman->title }}</span>
    </div>
    <article class="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
        ...
        <div class="flex items-center text-sm text-gray-500 mb-6">
            <span>Ditulis oleh: <strong>{{ $berita->author ?? 'Admin' }}
            <span>Dipublikasikan pada: <strong>{{ $pengumuman->created_at->isoFormat('dddd, D MMMM YYYY') }}</strong></span>
        </div>
